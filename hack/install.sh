...
oc apply -f "${ROOT_DIR}/config/rbac/discovery_role.yaml"
...
info "Next steps:"
info ""
info "  1. Prepare a namespace (cluster-admin required):"
info "     oc new-project tinycode-dev"
info "     oc create rolebinding tinycode-operator-admin \\"
...
info "       -n tinycode-dev"
info ""
info "  3. (Optional) Annotate model services for auto-discovery:"
info "     oc annotate svc <predictor-svc> tinycode.dev/discover=vllm -n <model-ns>"
info ""
info "  4. Apply a TinycodeInstance:"
info "     oc apply -f config/samples/tinycode_v1alpha1_basic.yaml"
info ""
info "  5. Get the URL:"
info "     oc get tinycodeinstance -n tinycode-dev -o wide"
info ""
info "  See README.md 'Namespace Preparation' section for full details."
